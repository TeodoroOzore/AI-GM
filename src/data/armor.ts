...
export const ARMOR_CATALOG: ArmorCatalogEntry[] = [
  ...
  // ── Ligeras con rareza ──
  { name: 'Cuero de cazador del bosque', type: 'ligera', acBase: 12, addDex: true, stealthDisadvantage: false, cost: '150 po', rarity: 'poco común', magical: true, description: 'Cuero curtido con esencia del bosque, CA 12 + DES, ventaja en sigilo en zonas boscosas.', weightKg: 5.5 },
  { name: 'Cuero de sombras', type: 'ligera', acBase: 13, addDex: true, stealthDisadvantage: false, cost: '700 po', rarity: 'raro', magical: true, description: 'Cuero negro que se funde con la oscuridad, CA 13 + DES, ventaja en sigilo.', weightKg: 5 },
  { name: 'Armadura de cuero de dragón', type: 'ligera', acBase: 14, addDex: true, stealthDisadvantage: false, cost: '4500 po', rarity: 'muy raro', magical: true, description: 'Cuero de dragón, CA 14 + DES, resistencia al tipo de daño del dragón.', weightKg: 5 },
  { name: 'Abanico del Viento', type: 'ligera', acBase: 14, addDex: true, stealthDisadvantage: false, cost: '10000 po', rarity: 'legendario', magical: true, description: 'Armadura ligera legendaria, CA 14 + DES, desventaja a ataques contra ti.', requirements: 'Item de búsqueda (ver misiones)', weightKg: 4.5 },
  ...
  // ── Medias con rareza ──
  { name: 'Cota de escamas enanas', type: 'media', acBase: 15, addDex: true, maxDex: 2, stealthDisadvantage: false, cost: '1200 po', rarity: 'poco común', magical: true, description: 'Escamas de acero enano con runas, CA 15 + DES (máx 2), sin penalización de sigilo.', weightKg: 12 },
  ...
  { name: 'Malla de mitril', type: 'media', acBase: 16, addDex: true, maxDex: 2, stealthDisadvantage: false, cost: '8000 po', rarity: 'muy raro', magical: true, description: 'Camisa de malla de mitril, ligera y silenciosa, CA 16 + DES (máx 2).', weightKg: 4 },
  ...
  { name: 'Armadura de placas de dragón', type: 'pesada', acBase: 19, addDex: false, stealthDisadvantage: true, strRequirement: 15, cost: '12000 po', rarity: 'muy raro', magical: true, description: 'Placas forjadas con escamas de dragón, CA 19, resistencia a un elemento.', requirements: 'Item de búsqueda (ver misiones)', weightKg: 26 },
  ...
  { name: 'Escudo de torre', type: 'escudo', acBase: 2, addDex: false, stealthDisadvantage: true, strRequirement: 13, cost: '300 po', rarity: 'poco común', description: 'Escudo enorme que cubre el cuerpo, +2 CA, puedes cubrirte completamente (cobertura tres cuartos).', weightKg: 13 },
