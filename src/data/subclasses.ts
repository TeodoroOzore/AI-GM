...
export const SUBCLASS_CATALOG: Record<string, SubclassDetail> = {
  ...
  'Camino del Berserker': {
    ...
    features: [
      { level: 3, title: 'Frenesí', description: 'Al entrar en Furia, podés elegir hacer un Frenesí. Durante la furia, podés hacer un ataque cuerpo a cuerpo adicional como acción bonus en cada turno. Cuando la furia termina, sufrís 1 nivel de agotamiento.', type: 'feature' },
      { level: 6, title: 'Furia Inconcebible', description: 'No podés ser encantado ni asustado mientras estés en Furia. Si entrás en furia estando encantado o asustado, el efecto se suspende durante la furia.', type: 'feature' },
      ...
      { level: 14, title: 'Represalia', description: 'Cuando recibís daño de una criatura adyacente, podés usar tu reacción para hacer un ataque cuerpo a cuerpo contra ella.', type: 'feature' }
    ]
  },
  'Camino del Guerrero Totémico': {
    name: 'Camino del Guerrero Totémico',
    className: 'Bárbaro',
    description: 'Aprendés a sintonizar tu alma con los espíritus de la naturaleza y las bestias, obteniendo la fuerza del Oso, la agilidad del Águila o la ferocidad del Lobo.',
    ...
    features: [
      ...
      { level: 3, title: 'Espíritu Totémico (Oso / Lobo / Águila)', description: 'Oso: Tenés resistencia a todo daño excepto psíquico mientras estás en Furia. Lobo: Tus aliados tienen ventaja en ataques cuerpo a cuerpo contra enemigos adyacentes a ti. Águila: Los enemigos tienen desventaja en ataques de oportunidad contra ti y podés Esprintar como acción bonus.', type: 'feature' },
      { level: 6, title: 'Aspecto de la Bestia', description: 'Oso: Tu capacidad de carga se duplica y tenés ventaja en pruebas de Fuerza para empujar/levantar. Lobo: Podés rastrear a paso rápido y moverte en sigilo a paso normal. Águila: Podés ver hasta 1 km sin problemas.', type: 'feature' },
      { level: 10, title: 'Caminante Espiritual', description: 'Podés lanzar el conjuro "Comunión con la Naturaleza" como ritual.', type: 'spell' },
      { level: 14, title: 'Sintonía Totémica', description: 'Oso: Enemigos adyacentes tienen desventaja al atacar a aliados. Águila: Podés volar temporalmente durante tu turno mientras estás en Furia. Lobo: Podés derribar criaturas grandes o menores como acción bonus al atacar.', type: 'feature' }
    ]
  },
  'Camino del Corazón Salvaje': {
    ...
    features: [
      { level: 3, title: 'Aura de Tormenta', description: 'Emanás un aura de 3m durante la furia. Elegí entorno: Desierto (2 daño de fuego a enemigos como acción bonus), Tundra (2 PG temporales a aliados) o Mar (1d6 daño de rayo a una criatura).', type: 'aura' },
      { level: 6, title: 'Alma Elemental', description: 'Ganás resistencia a Fuego (Desierto), Frío (Tundra) o Rayo (Mar), y podés respirar bajo el agua o tolerar temperaturas extremas.', type: 'feature' },
  ...
  'Colegio del Conocimiento': {
    ...
    features: [
      { level: 3, title: 'Competencias Adicionales', description: 'Obtenés competencia en 3 habilidades cualesquiera a tu elección.', type: 'proficiency' },
      ...
      { level: 6, title: 'Secretos Mágicos Adicionales', description: 'Aprendés 2 conjuros cualesquiera de cualquier lista de clase (de nivel de conjuro que puedas lanzar). Se consideran conjuros de bardo.', type: 'spell' },
      { level: 14, title: 'Habilidad Insuperable', description: 'Cuando hagas una prueba de habilidad, podés lanzar 1 dado de Inspiración Bárdica y sumarlo al total.', type: 'feature' }
    ]
  },
  'Colegio del Valor': {
    ...
    features: [
      ...
      { level: 6, title: 'Ataque Extra', description: 'Podés atacar dos veces en lugar de una cuando realizás la acción de Atacar en tu turno.', type: 'feature' },
      { level: 14, title: 'Magia de Combate', description: 'Cuando usás tu acción para lanzar un conjuro de Bardo, podés realizar un ataque con arma como acción bonus.', type: 'feature' }
    ]
  },
  'Colegio de la Glamour': {
    ...
    features: [
      ...
      { level: 3, title: 'Performance Cautivadora', description: 'Tras una actuación de 1 minuto, podés encantar a un grupo de espectadores que deben superar salvación de Sabiduría o quedar fascinados por ti.', type: 'feature' },
      { level: 6, title: 'Manto de Majestad', description: 'Lanzá el conjuro "Orden" como acción bonus durante 1 minuto sin gastar espacio de conjuro. Las criaturas encantadas fallan automáticamente su salvación.', type: 'spell' },
  ...
  'Dominio de la Vida': {
    ...
    features: [
      ...
      { level: 6, title: 'Curación Bendita', description: 'Cuando lanzás un conjuro de curación sobre otra criatura, también te curás a ti mismo 2 + nivel del conjuro PG.', type: 'feature' },
      { level: 8, title: 'Golpe Divino', description: 'Una vez por turno, podés infligir 1d8 de daño radiante adicional al golpear con un ataque con arma.', type: 'feature' }
    ]
  },
  'Dominio de la Guerra': {
    ...
    features: [
      { level: 1, title: 'Sacerdote de la Guerra', description: 'Al realizar la acción de Atacar, podés realizar un ataque con arma adicional como acción bonus (usos = Modificador de Sabiduría por descanso largo).', type: 'feature' },
      { level: 2, title: 'Canalizar Divinidad: Golpe Guiado', description: 'Podés sumar +10 a una tirada de ataque propia justo después de ver el resultado del d20.', type: 'feature' },
      { level: 6, title: 'Canalizar Divinidad: Bendición de la Guerra', description: 'Podés otorgar el bonificador de +10 en el ataque a una criatura aliada a 9 metros.', type: 'feature' },
      { level: 8, title: 'Golpe Divino', description: 'Infligís 1d8 de daño físico adicional (del tipo del arma) una vez por turno al impactar.', type: 'feature' }
    ]
  },
  'Dominio de la Luz': {
    ...
    features: [
      { level: 1, title: 'Truco de Luz Gratuito', description: 'Aprendés el truco "Luz" si no lo tenías ya.', type: 'spell' },
      ...
      { level: 6, title: 'Destello Mejorado', description: 'Podés usar Destello Protector para proteger a un aliado atacado a 9m de ti.', type: 'feature' },
      { level: 8, title: 'Conjuro Potente', description: 'Sumás tu modificador de Sabiduría al daño que infligís con cualquier truco de clérigo.', type: 'feature' }
    ]
  },
  'Dominio Arcano': {
    name: 'Dominio Arcano',
    ...
    features: [
      { level: 1, title: 'Iniciado Arcano', description: 'Ganas competencia en Arcanos y aprendés 2 trucos de la lista de Mago que se cuentan como trucos de clérigo.', type: 'spell' },
      ...
      { level: 6, title: 'Brecha Arcana', description: 'Cuando curás a una criatura con un conjuro de nivel 1+, podés disipar un conjuro activo sobre ella de nivel igual o menor al espacio usado.', type: 'feature' }
    ]
  },
  ...
  'Círculo de la Tierra': {
    ...
    features: [
      { level: 2, title: 'Truco Adicional', description: 'Aprendés un truco de druida adicional a tu elección.', type: 'spell' },
      { level: 2, title: 'Recuperación Natural', description: 'Durante un descanso corto, podés recuperar espacios de conjuro gastados con un nivel combinado igual a la mitad de tu nivel de druida.', type: 'feature' },
      ...
      { level: 6, title: 'Zancada de Tierra', description: 'El terreno difícil no mágico no te cuesta movimiento extra y podés pasar por vegetación espinosa sin sufrir daño.', type: 'feature' }
    ]
  },
  'Círculo de la Luna': {
    ...
    features: [
      { level: 2, title: 'Forma Salvaje Combativa', description: 'Podés usar Forma Salvaje como Acción Bonus en lugar de Acción Normal.', type: 'feature' },
      { level: 2, title: 'Formas del Círculo', description: 'Podés transformarte en bestias más poderosas (CR 1 a nivel 2, CR 2 a nivel 6, etc.), ignorando restricciones normales de CR.', type: 'feature' },
      { level: 2, title: 'Curación Lunar', description: 'Mientras estés en Forma Salvaje, podés gastar 1 espacio de conjuro como acción bonus para recuperar 1d8 PG por cada nivel del espacio gastado.', type: 'feature' },
      ...
      { level: 10, title: 'Forma Salvaje Elemental', description: 'Podés gastar 2 usos de Forma Salvaje para transformarte en un Elemental de Aire, Tierra, Fuego o Agua.', type: 'feature' }
    ]
  },
  'Círculo de las Estrellas': {
    ...
    features: [
      { level: 2, title: 'Mapa Estelar', description: 'Podés lanzar el conjuro "Guiado" sin gastar espacios de conjuro un número de veces igual a tu bono de competencia.', type: 'spell' },
      { level: 2, title: 'Forma Estelar', description: 'Asumís un aspecto luminoso. Elegí constelación: Arquero (disparar flecha estelar 1d8+SAB como acción bonus), Cáliz (curación extra 1d8+SAB al curar) o Dragón (mínimo 10 en d20 para mantener concentración).', type: 'feature' },
      { level: 6, title: 'Presagio Cósmico', description: 'Tirás un d6 tras un descanso largo (Par: Weal / Impar: Woe) para sumar o restar 1d6 a tiradas de aliados o enemigos.', type: 'feature' }
    ]
  },
  ...
  'Cazador': {
    ...
    features: [
      { level: 3, title: 'Táctica de Cazador', description: 'Elegí 1 opción: Asesino de Gigantes (+1d8 de daño a enemigos heridos), Matagigantes (reacción para atacar a criaturas Grandes que te fallen) o Deflector de Hordas (ataque extra a una segunda criatura adyacente).', type: 'feature' },
      { level: 7, title: 'Defensa de Cazador', description: 'Elegí 1 opción: Escapar de la Horda (desventaja en ataques de oportunidad contra ti), Táctica Acero (+4 CA contra ataques subsecuentes del mismo enemigo) o Esquivar en un Santiamén.', type: 'feature' },
  ...
  'Señor de las Bestias': {
    ...
    features: [
      { level: 3, title: 'Compañero Bestia', description: 'Invocás o vinculás un espíritu bestial. En combate actúa en tu turno. Podés ordenarle atacar usando uno de tus ataques de la acción de Atacar.', type: 'companion' },
  ...
  'Vagabundo Feérico': {
    ...
    features: [
      { level: 3, title: 'Golpes Terroríficos', description: 'Una vez por turno al golpear a una criatura con un arma, infligís 1d4 de daño psíquico extra.', type: 'feature' },
      { level: 3, title: 'Presencia Feérica', description: 'Sumás tu modificador de Sabiduría a cualquier prueba de habilidad de Carisma que realices.', type: 'feature' },
      { level: 7, title: 'Giro Encantador', description: 'Ganas ventaja en salvaciones contra ser Encantado o Asustado. Si tú o un aliado salvan, podés redirigir el efecto a un enemigo.', type: 'feature' }
    ]
  },
  ...
  'Campeón': {
    ...
    features: [
      ...
      { level: 7, title: 'Atleta Notable', description: 'Sumás la mitad de tu bonificador de competencia (redondeado hacia arriba) a cualquier prueba de Fuerza, Destreza o Constitución que no la tenga ya. Además, aumenta tu distancia de salto.', type: 'feature' },
      { level: 10, title: 'Estilo de Combate Adicional', description: 'Podés elegir un segundo Estilo de Combate de la lista de Guerrero.', type: 'proficiency' },
      ...
      { level: 18, title: 'Superviviente', description: 'Al inicio de tu turno en combate, recuperás 5 + Modificador de CON PG si tenés menos de la mitad de tus PG máximos.', type: 'feature' }
    ]
  },
  'Maestro de Batalla': {
    ...
    features: [
      { level: 3, title: 'Superioridad Táctica', description: 'Aprendés 3 Maniobras de combate y recibís 4 Dados de Superioridad (d8). Gastás un dado para ejecutar una maniobra. Se recuperan en descansos cortos o largos.', type: 'maneuver' },
      { level: 3, title: 'Estudiante de la Guerra', description: 'Obtenés competencia con un tipo de herramientas de artesano a tu elección.', type: 'proficiency' },
  ...
  'Caballero Arcano': {
    ...
    features: [
      { level: 3, title: 'Lanzamiento de Conjuros', description: 'Usás Inteligencia para lanzar conjuros de la lista de Mago (enfocado en Evocación y Abjuración). Aprendés 2 trucos y 3 conjuros de nivel 1.', type: 'spell' },
      { level: 3, title: 'Vínculo con Arma', description: 'Realizás un ritual de 1 hora para vincularte con hasta 2 armas. No podés ser desarmado de ellas y podés invocarlas a tu mano como acción bonus.', type: 'feature' },
      { level: 7, title: 'Magia de Combate', description: 'Cuando usás tu acción para lanzar un truco, podés realizar un ataque con arma como acción bonus.', type: 'feature' },
  ...
  'Linaje Dracónico': {
    ...
    features: [
      { level: 1, title: 'Ancestro Dracónico', description: 'Elegí un color de dragón (ej. Rojo/Fuego, Azul/Rayo, Blanco/Frío). Aprendés a hablar Dracónico y tenés ventaja en pruebas de interacción con dragones.', type: 'feature' },
      { level: 1, title: 'Resiliencia Dracónica', description: 'Tu máximo de PG aumenta en 1 por cada nivel de hechicero. Además, si no llevás armadura, tu CA base es 13 + Modificador de Destreza.', type: 'feature' },
      { level: 6, title: 'Afinidad Elemental', description: 'Al lanzar un conjuro que inflija el tipo de daño de tu ancestro dracónico, sumás tu modificador de Carisma al daño. Podés gastar 1 Punto de Hechicería para ganar resistencia a ese elemento durante 1 hora.', type: 'feature' },
  ...
  'Magia Salvaje': {
    ...
    features: [
      { level: 1, title: 'Oleada de Magia Salvaje', description: 'Al lanzar un conjuro de nivel 1+, el DM puede hacerte tirar 1d20. Si sale 1, tirás en la tabla de Oleada de Magia Salvaje (d100) produciendo efectos aleatorios.', type: 'feature' },
      { level: 1, title: 'Mareas de Caos', description: 'Ganas ventaja en una tirada de ataque, prueba de habilidad o salvación. Recuperás este uso tras un descanso largo o cuando el DM active una Oleada de Magia Salvaje.', type: 'feature' },
  ...
  'Alma Mecánica': {
    ...
    features: [
      { level: 1, title: 'Restaurar el Orden', description: 'Como reacción cuando una criatura a 18m va a tirar con ventaja o desventaja, podés anular esa ventaja o desventaja. Usos = Bonificador de competencia.', type: 'feature' },
  ...
  'Escuela de Evocación': {
    ...
    features: [
      ...
      { level: 2, title: 'Esculpido de Conjuros', description: 'Al lanzar un conjuro de evocación de área, podés elegir un número de criaturas (1 + nivel del conjuro) para que tengan éxito automáticamente en la salvación y no reciban daño si normalmente recibirían la mitad.', type: 'feature' },
      ...
      { level: 10, title: 'Evocación Potenciada', description: 'Sumás tu modificador de Inteligencia a una tirada de daño de cualquier conjuro de evocación de mago que lances.', type: 'feature' }
    ]
  },
  'Escuela de Abjuración': {
    ...
    features: [
      ...
      { level: 2, title: 'Bastión Arcano', description: 'Al lanzar un conjuro de abjuración de nivel 1+, creás un escudo mágico que absorbe daño igual a (2 x Nivel de Mago + Mod INT). Se recarga al lanzar más abjuraciones.', type: 'feature' },
      ...
      { level: 10, title: 'Abjurador Robusto', description: 'Sumás tu bonificador de competencia a las pruebas de habilidad para Anular Magia o Disipar Magia.', type: 'feature' }
    ]
  },
  'Escuela de Nigromancia': {
    ...
    features: [
      ...
      { level: 2, title: 'Cosecha Oscura', description: 'Una vez por turno, al matar a una criatura con un conjuro de nivel 1+, recuperás PG iguales al doble del nivel del conjuro (el triple si es de Nigromancia).', type: 'feature' },
      { level: 6, title: 'Servidores de la Muerte', description: 'Añadís "Animar a los Muertos" a tu grimorio. Al lanzarlo, podés alzar un esqueleto o zombi adicional. Sus PG máximos aumentan en tu nivel de mago y su daño suma tu bonificador de competencia.', type: 'companion' }
    ]
  },
  ...
  'Camino de la Mano Abierta': {
    ...
    features: [
      { level: 3, title: 'Técnica de la Mano Abierta', description: 'Al impactar con un golpe de Ráfaga de Golpes, podés imponer 1 efecto: derribar al objetivo (salvación de FUE), empujarlo 4.5m (salvación de FUE) o impedirle usar reacciones hasta el final de tu siguiente turno.', type: 'feature' },
      { level: 6, title: 'Claridad de Cuerpo', description: 'Como acción en tu turno, podés curarte PG iguales a (3 x tu nivel de Monje). Requiere descanso largo para reutilizar.', type: 'feature' },
      ...
      { level: 17, title: 'Palma Temblorosa', description: 'Podés imbuir vibraciones mortales con 3 Puntos de Ki. Más tarde, como acción, podés detener las vibraciones: la criatura cae a 0 PG si falla salvación de Constitución (o recibe 10d10 de daño si la supera).', type: 'feature' }
    ]
  },
  'Camino de la Sombra': {
    ...
    features: [
      { level: 3, title: 'Artes de la Sombra', description: 'Gastá 2 Puntos de Ki para lanzar los conjuros: Oscuridad, Visión Oscura, Pasar sin Rastro o Silencio sin componentes materiales. Aprendés el truco Ilusión Menor.', type: 'spell' },
      { level: 6, title: 'Paso de las Sombras', description: 'Mientras estés en penumbra u oscuridad, podés teletransportarte hasta 18 metros a otra zona de penumbra como Acción Bonus y ganar ventaja en tu primer ataque cuerpo a cuerpo.', type: 'feature' },
      { level: 11, title: 'Manto de Sombras', description: 'Mientras estés en penumbra u oscuridad, podés usar tu acción para volverte invisible hasta que ataques o lances un conjuro.', type: 'feature' }
    ]
  },
  'Camino de los Cuatro Elementos': {
    ...
    features: [
      { level: 3, title: 'Disciplinas del Ki Elemental', description: 'Aprendés disciplinas como "Colmillo del Dragón de Fuego" (ataque a distancia con fuego) o "Empuje de las Olas" para moldear los elementos con Puntos de Ki.', type: 'feature' },
  ...
  'Juramento de Devoción': {
    ...
    features: [
      { level: 3, title: 'Canalizar Divinidad: Arma Sagrada', description: 'Imbuís tu arma con energía positiva durante 1 minuto. Sumás tu Modificador de Carisma a las tiradas de ataque y el arma emite luz brillante a 6m.', type: 'feature' },
      ...
      { level: 7, title: 'Aura de Devoción', description: 'Tú y los aliados dentro de 3m no podés ser encantados mientras estés consciente.', type: 'aura' },
  ...
  'Juramento de Venganza': {
    ...
    auras: [
      { levelUnlocked: 7, name: 'Paso Implacable', range: 'Personal', description: 'Al realizar un ataque de oportunidad, podés moverte la mitad de tu velocidad como parte de la misma reacción sin provocar O.A.' }
    ],
    spells: [
    ...
    features: [
      { level: 3, title: 'Canalizar Divinidad: Voto de Enemistad', description: 'Como Acción Bonus, jurás enemistad a un enemigo a 9m. Tenés VENTAJA en todas las tiradas de ataque contra él durante 1 minuto o hasta que caiga a 0 PG.', type: 'feature' },
      ...
      { level: 7, title: 'Paso Implacable', description: 'Cuando golpeas a una criatura con un ataque de oportunidad, podés moverte hasta la mitad de tu velocidad como parte de la reacción sin provocar ataques de oportunidad.', type: 'aura' }
    ]
  },
  'Juramento de los Ancestros': {
    ...
    features: [
      ...
      { level: 15, title: 'Sentinela Indomable', description: 'Cuando caés a 0 PG y no morís al instante, podés elegir caer a 1 PG en su lugar (1 vez por descanso largo). Tampoco sufrís achaques por vejez.', type: 'feature' }
    ]
  },
  ...
  'Ladrón': {
    ...
    features: [
      { level: 3, title: 'Manos Rápidas', description: 'Podés usar la Acción Bonus concedida por Acción Astuta para realizar una prueba de Juego de Manos, usar tus herramientas de ladrón para desarmar una trampa o abrir una cerradura, o usar la acción de Usar un Objeto.', type: 'feature' },
      { level: 3, title: 'Trabajo en las Alturas', description: 'Trepar ya no te cuesta movimiento extra. Además, aumentás tu distancia de salto una cantidad de metros igual a tu Modificador de Destreza.', type: 'feature' },
      { level: 9, title: 'Sigilo Supremo', description: 'Tenés ventaja en las pruebas de Destreza (Sigilo) si te movés a no más de la mitad de tu velocidad en ese turno.', type: 'feature' },
      { level: 13, title: 'Uso de Dispositivos Mágicos', description: 'Ignorás todos los requisitos de clase, raza y nivel para la sintonización y uso de cualquier objeto mágico.', type: 'feature' }
    ]
  },
  'Asesino': {
    name: 'Asesino',
    ...
    coreMechanic: 'Ventaja automática contra enemigos que no hayan actuado y Golpes Críticos automáticos si sorprendés al objetivo.',
    ...
    features: [
      ...
      { level: 3, title: 'Asesinar', description: 'Tenés VENTAJA en las tiradas de ataque contra cualquier criatura que aún no haya actuado en el combate. Además, cualquier ataque que impacte a una criatura sorprendida es automáticamente un GOLPE CRÍTICO.', type: 'feature' },
      { level: 9, title: 'Infiltración Experta', description: 'Podés crear falsas identidades creíbles con historial, documentación y vestimenta tras dedicar 7 días de estudio y 25 po.', type: 'feature' },
  ...
  'Embaucador Arcano': {
    ...
    features: [
      { level: 3, title: 'Lanzamiento de Conjuros', description: 'Lanzás conjuros de la lista de Mago (enfocado en Ilusión y Encantamiento) usando Inteligencia.', type: 'spell' },
      { level: 3, title: 'Mano de Mago Mejorada', description: 'Tu truco Mano de Mago es invisible. Podés usarla como Acción Bonus para hurtar objetos de recipientes, poner objetos en bolsillos de otros o abrir cerraduras/desactivar trampas a distancia.', type: 'feature' },
      { level: 9, title: 'Emboscada Mágica', description: 'Si estás oculto de una criatura cuando le lanzás un conjuro, esa criatura tiene desventaja en las salvaciones contra el conjuro ese turno.', type: 'feature' }
    ]
  },
  ...
  'Patrón Arquihada': {
    ...
    features: [
      { level: 1, title: 'Presencia Feérica', description: 'Como acción, podés hacer que todas las criaturas en un cubo de 3m se sometan a una salvación de Carisma o queden Asustadas o Encantadas por ti hasta tu siguiente turno (1 vez por descanso).', type: 'feature' },
      ...
      { level: 10, title: 'Mente Beguiling', description: 'Eres inmune a ser Encantado. Cuando otra criatura intente encantarte, podés usar tu reacción para redirigir el encanto a ella.', type: 'feature' }
    ]
  },
  'Patrón Fiendish': {
    ...
    features: [
      { level: 1, title: 'Bendición del Oscuro', description: 'Cuando reducís a una criatura hostil a 0 PG, ganás PG temporales iguales a tu Modificador de Carisma + tu nivel de Brujo.', type: 'feature' },
      { level: 6, title: 'Propia Suerte Oscura', description: 'Podés sumar 1d10 a una prueba de habilidad o salvación que realices (1 vez por descanso corto o largo).', type: 'feature' },
      { level: 10, title: 'Resiliencia Infernal', description: 'Tras un descanso, elegí un tipo de daño: ganás resistencia a ese daño (salvo armas mágicas o de plata).', type: 'feature' }
    ]
  },
  'Patrón Great Old One': {
    ...
    features: [
      { level: 1, title: 'Mente Despierta', description: 'Podés comunicarte telepáticamente con cualquier criatura que veas a 9m de ti, independientemente de si comparten idioma.', type: 'feature' },
      { level: 6, title: 'Escudo Psíquico', description: 'Cuando una criatura te haga una tirada de ataque, podés usar tu reacción para imponerle desventaja. Si falla, tu siguiente ataque contra ella tiene ventaja.', type: 'feature' },
      { level: 10, title: 'Escudo Mental', description: 'Tus pensamientos no pueden ser leídos por magia salvo que lo permitas. Además, tenés resistencia al daño Psíquico.', type: 'feature' }
    ]
  }
};
